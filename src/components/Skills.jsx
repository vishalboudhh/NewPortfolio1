...
const Skills = () => {
  return (
    <section
      id="skills"
      className="min-h-screen flex flex-col justify-center bg-[#222834] overflow-hidden mb-28 px-4"
    >
      {/* Description Section */}
      <div className="flex flex-col items-center md:items-start text-center md:text-left mb-8 mx-auto max-w-3xl">
        <h1 className="text-cyan-500 text-4xl md:text-6xl font-bold mt-14">
          Skills
        </h1>
      ...
      <div className="w-full overflow-hidden">
        <div className="flex gap-6 items-center animate-scroll whitespace-nowrap h-64 md:h-96">
          <img
            src="https://astconsulting.in/wp-content/uploads/2023/08/MongoDB-sm-logo-500x400-1-1.gif"
            alt="MongoDB Logo"
            className="w-24 md:w-40 rounded-2xl"
          />
          <img
