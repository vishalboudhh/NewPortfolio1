  ...
  return (
    <section id="about" className="min-h-screen flex items-center bg-gray-900 py-10">
      <div className="container mx-auto px-4 flex flex-col md:flex-row items-center justify-between gap-10">
        {/* Text Section */}
        <div className="md:w-1/2 m-28">
          <h1 className="text-blue-500 text-4xl md:text-6xl font-bold">About</h1>
          <p className="text-white mt-4 text-wrap text-lg  text-justify md:text-2xl">
