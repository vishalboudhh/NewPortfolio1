    ...
    return (
        <section className="h-screen" id="projects">
            <div className="h-screen flex flex-col justify-center items-center text-center">
                <h1 className="font-bold text-center text-blue-500 text-6xl mt-10 mb-12">
                    Projects
                </h1>
                <div className="grid gap-8 grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 cursor-pointer">
                    {/* Project 1 */}
                    <div className="bg-gray-600 rounded-lg shadow-lg overflow-hidden transform transition-all duration-300 hover:scale-105 hover:-translate-y-2">
                        <img
                    ...
                    <div className="bg-gray-600 rounded-lg shadow-lg overflow-hidden transform transition-all duration-300 hover:scale-105 hover:-translate-y-2">
                        ...
                        <div className="p-6 text-white">
                            ...
                            <p>
                                Doctor appointment booking system built using MERN.
                            </p>
                        </div>
                    </div>
                    {/* Project 3 */}
                    <div className="bg-gray-600 text-white rounded-lg shadow-lg overflow-hidden transform transition-all duration-300 hover:scale-105 hover:-translate-y-2">
                        <img
                        ...
                        <div className="p-6">
                            ...
                            <p>
                                Book management system built using MERN.
                            </p>
                        </div>
                    </div>
                    {/* Project 4 */}
                    <div className="bg-gray-600 text-white rounded-lg shadow-lg overflow-hidden transform transition-all duration-300 hover:scale-105 hover:-translate-y-2">
                        ...
                        <div className="p-6">
                            ...
                            <p>
                                Chat app built using React and Node.js.
                            </p>
                        </div>
                    </div>
                </div>
